      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollStyle}>
        <View style={{ flex: 1, flexDirection: 'column' }}>
          <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 20, paddingRight: 20, marginBottom: 4 }}>
            <Text style={{ color: colors.BLACK, textAlign: 'left', lineHeight: 45, fontSize: 22, fontWeight: '500' }}>{t('bill_details')}</Text>
            {userdata && userdata.usertype == 'rider' && (booking.status == 'PAYMENT_PENDING' || (appcat == 'taxi' && booking.status == "PENDING"))? 
                ...
                <TouchableOpacity
                  onPress={() => { removePromo() }}>
                  <Text style={{ color: 'red', textAlign: 'left', lineHeight: 45, fontSize: 14, fontWeight: '500' }}>{t('remove_promo')}</Text>
                </TouchableOpacity>
                :
                <TouchableOpacity
                  onPress={() => { openPromoModal() }}>
                  <Text style={{ color: colors.GREEN.bright, textAlign: 'left', lineHeight: 45, fontSize: 14, fontWeight: '500' }}>{t('apply_promo')}</Text>
                </TouchableOpacity>
              : null}
          </View>
          ...
          {userdata && userdata.usertype == 'driver' ?
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 25, paddingRight: 25 }}>
              <Text style={{ color: colors.BLACK, textAlign: 'left', lineHeight: 45, fontSize: 16 }}>{t('distance')}</Text>
          ...
          {userdata && userdata.usertype == 'driver' ?
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 25, paddingRight: 25 }}>
              <Text style={{ color: colors.BLACK, textAlign: 'left', lineHeight: 45, fontSize: 16 }}>{t('total_time')}</Text>
              <Text style={{ color: colors.BLACK, textAlign: 'left', lineHeight: 45, fontSize: 16 }}>{(booking && booking.total_trip_time ? parseFloat(booking.total_trip_time / 60).toFixed(1)  : '0') + ' ' + t('mins')}</Text>
            </View>
            : null}
          {userdata && userdata.usertype == 'driver' ?
            <View style={{
          ...
          {userdata ?
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 25, paddingRight: 25 }}>
              <Text style={{ color: colors.BLACK, textAlign: 'left', lineHeight: 45, fontSize: 16 }}>{userdata.usertype == 'rider' ? t('your_fare'): t('total_fare')}</Text>
          ...
          {userdata ?
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 25, paddingRight: 25 }}>
              <Text style={{ color: colors.BLACK, textAlign: 'left', lineHeight: 45, fontSize: 16 }}>{t('promo_discount')}</Text>
          ...
          {useWalletCash || (booking.status != 'PAYMENT_PENDING' && booking.usedWalletMoney)?
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 25, paddingRight: 25 }}>
              <Text style={{ color: colors.BLACK, textAlign: 'left', lineHeight: 45, fontSize: 16 }}>{t('WalletPayment')}</Text>
          ...
          {userdata ?
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 25, paddingRight: 25 }}>
              <Text style={{ color: colors.GREEN.bright, textAlign: 'left', lineHeight: 45, fontSize: 24, fontWeight: '500' }}>{t('payable_ammount')}</Text>
              <Text style={{ color: colors.GREEN.bright, textAlign: 'left', lineHeight: 45, fontSize: 24, fontWeight: 'bold' }}>{settings.symbol} {payDetails.payableAmount ? parseFloat(payDetails.payableAmount).toFixed(2) : 0.00}</Text>
            </View>
            : null}
        </View>

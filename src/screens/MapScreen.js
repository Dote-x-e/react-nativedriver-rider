        ...
        <View style={styles.container}>
            ...
            <View style={styles.buttonBar}>
                <Button
                    ...
                    buttonStyle={[styles.buttonStyle, { backgroundColor: colors.GREY.default }]}
                ...
                <Button
                    ...
                    titleStyle={styles.buttonTitleStyle}
                    onPress={onPressBook}
                    buttonStyle={[styles.buttonStyle, { backgroundColor: appcat == 'taxi' ? colors.YELLOW.primary : colors.ORANGE.bright }]}
                    containerStyle={styles.buttonContainer}
                />
            </View>
            ...
            {activeBookings && activeBookings.length >= 1 ?
                ...
                :
                <View style={[styles.topTitle, { width: 110 }]}>
            ...
            <View style={styles.addressBar}>
                ...
                <View style={styles.contentStyle}>
                    <TouchableOpacity onPress={() => tapAddress('pickup')} style={styles.addressStyle1}>
                        <Text numberOfLines={1} style={[styles.textStyle, tripdata.selected == 'pickup' ? { fontSize: 18 } : { fontSize: 14 }]}>{tripdata.pickup && tripdata.pickup.add ? tripdata.pickup.add : t('map_screen_where_input_text')}</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => tapAddress('drop')} style={styles.addressStyle2}>
                        <Text numberOfLines={1} style={[styles.textStyle, tripdata.selected == 'drop' ? { fontSize: 18 } : { fontSize: 14 }]}>{tripdata.drop && tripdata.drop.add ? tripdata.drop.add : t('map_screen_drop_input_text')}</Text>
                    </TouchableOpacity>
                </View>
            </View>
            <View style={styles.fullCarView}>
                <ScrollView horizontal={true} style={styles.fullCarScroller} showsHorizontalScrollIndicator={false}>
                    {allCarTypes.map((prop, key) => {
                        return (
                            <View key={key} style={[styles.cabDivStyle, { backgroundColor: prop.active == true ? colors.YELLOW.secondary : colors.WHITE }]}>
                                ...
                                <View style={styles.textViewStyle}>
                                    ...
                                    <View style={{ flexDirection: 'row', alignItems: 'center', marginLeft: 10 }}>
                                        <Text style={[styles.text2, { fontWeight: 'bold', color: colors.GREY.btnPrimary }]}>{settings.symbol}{prop.rate_per_unit_distance} / {settings.convert_to_mile ? t('mile') : t('km')} </Text>
                                        {

            ...
            <ScrollView>
                ...
                <View style={styles.rideDesc}>
                        ...
                        <View style={styles.userView}>
                            ...
                            {paramData && paramData.rating > 0 ?
                                ...
                                <View style={styles.personTextView}>
                                    {/*My rating to driver */}
                                    <Text style={styles.ratingText}>{t('you_rated_text')}</Text>
                                    <Rating
                                        showRating
                                        type="star"
                                        fractions={3}
                    ...
                    {paramData && paramData.carType ?
                        <View style={[styles.userDesc, styles.avatarView]}>
                            ...
                            />
                            <View style={styles.userView}>
                                <Text style={styles.carNoStyle}>{paramData.vehicle_number ? paramData.vehicle_number : <Text> {t('car_no_not_found')}</Text>}</Text>
                ...
                {paramData && ['PENDING','PAID','COMPLETE'].indexOf(paramData.status) != -1 ?
                    <View style={styles.billView}>
                        <View style={styles.billView}>
                            <Text style={styles.billTitle}>{t('bill_details_title')}</Text>
                        </View>
                        <View style={styles.billOptions}>
                            <View style={styles.billItem}>
                                <Text style={styles.billName}>{t('your_trip')}</Text>
                            ...
                            <View style={styles.billItem}>
                                <View>
                                    <Text style={[styles.billName, styles.billText]}>{t('discount')}</Text>
                                    <Text style={styles.taxColor}>{t('promo_apply')}</Text>
                                </View>
                        ...
                        <View style={styles.paybleAmtView}>
                            <Text style={styles.billTitle}>{t('Customer_paid')}</Text>
                ...
                {paramData &&  ['PENDING','PAID','COMPLETE'].indexOf(paramData.status) != -1 ?
                    <View>
                        ...
                        <View style={styles.paymentTextView}>
                            <Text style={styles.billTitle}>{t('payment_status')}</Text>
                        </View>
                        {paramData && paramData.status ?
                            <View style={styles.billOptions}>
                                <View style={styles.billItem}>
                                    <Text style={styles.billName}>{t('payment_status')}</Text>
                                    <Text style={styles.billAmount}>{t(paramData.status)}</Text>

                                </View>
                                {['PAID','COMPLETE'].indexOf(paramData.status) != -1 ?
                                <View style={styles.billItem}>
                                    <Text style={styles.billName}>{t('pay_mode')}</Text>

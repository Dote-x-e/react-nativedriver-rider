        ...
        return (
            (curBooking && role == 'rider' && (curBooking.status == 'NEW' || curBooking.status == 'ACCEPTED')) ||
                ...
                <View style={{ flex: 1.5, flexDirection: 'row' }}>
                    {(role == 'rider' && !curBooking.pickup_image && (curBooking.status == 'NEW' || curBooking.status == 'ACCEPTED')) ||
                        ...
                        <View style={{ flex: 1 }}>
                            <Button
                                ...
                                buttonStyle={{ height: '100%', backgroundColor: colors.GREY.default }}
                                containerStyle={{ height: '100%' }}
                            />
                        </View>
                        : null}
                    {appcat == 'delivery' && role == 'driver' && !curBooking.pickup_image && (curBooking.status == 'ACCEPTED' || curBooking.status == 'ARRIVED') ?
                        <View style={{ flex: 1 }}>
                            <Button
                                ...
                                buttonStyle={{ height: '100%', backgroundColor: colors.ORANGE.bright }}
                                containerStyle={{ height: '100%' }}
                            />
                        </View>
                        : null}
                    {role == 'driver' && ((curBooking.pickup_image && appcat=='delivery') || appcat == 'taxi') && (curBooking.status == 'ACCEPTED' || curBooking.status == 'ARRIVED') ?
                        <View style={{ flex: 1 }}>
                            <Button
                                title={t('start_trip')}
                                loading={false}
                    ...
                    {appcat == 'delivery' && role == 'driver' && !curBooking.deliver_image && curBooking.status == 'STARTED' ?
                        <View style={{ flex: 1 }}>
                            <Button
                        ...
                        : null}
                    {role == 'driver' && ((curBooking.deliver_image && appcat=='delivery') || appcat == 'taxi') && curBooking.status == 'STARTED' ?
                        <View style={{ flex: 1 }}>
                            <Button
            ...
            >
                <View style={{ flex: 1, backgroundColor: "rgba(22,22,22,0.8)", justifyContent: 'center', alignItems: 'center' }}>
                    <View style={{ width: '80%', backgroundColor: colors.WHITE, borderRadius: 10, justifyContent: 'center', alignItems: 'center', flex: 1, maxHeight: 310,marginTop:15 }}>
                        ...
                        <View><Text style={{ color: colors.BLUE.default.primary, fontSize: 16, marginTop: 12 }}>{t('driver_assign_messege')}</Text></View>
        ...
        <View style={styles.mainContainer}>
            ...
            <View style={styles.mapcontainer}>
                ...
                {role == 'driver'?
                    ...
                    : null}
                {curBooking && !(curBooking.bookLater && curBooking.status=='NEW')?
                <TouchableOpacity
            ...
            <View style={styles.bottomContainer}>
                ...
                <View style={styles.otpContainer}>
                    <Text style={styles.cabText}>{t('booking_status')}: <Text style={styles.cabBoldText}>{curBooking && curBooking.status ? t(curBooking.status) : null} {curBooking && curBooking.status == 'ACCEPTED' ? '( ' + arrivalTime + ' ' + t('mins') + ' )' : ''}</Text></Text>
